...
class enemy_object (ship.ship_object):
    def __init__(self,art,context_size, context,ai,weapon,proj,mvmt_ptrn):
        self.weapon       = weapon([0,0],proj,mvmt_ptrn,context,context_size) # TODO: add proper initialization parameters  -- should go in calling context (enemy_holder) at least for ai
